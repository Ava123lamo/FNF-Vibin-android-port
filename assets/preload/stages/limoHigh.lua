function onCreate()
	-- background shit
	makeLuaSprite('limoSunset2', 'limo2/limoSunset2', -2000, -330);
	...
	makeAnimatedLuaSprite('Mom_Road','limo2/Mom_Road', -300, 650);
...
if t == 'sun' then
		setProperty('limoSunset2.x', -2000)
		doTweenX('limoSunset2','limoSunset2',-1490,105,'sineOut')
		end
	end